...
function startStopTime(startOrStop)
{
  ...
  if(startOrStop == 1){
    if(count1 == 1){
    interval = setInterval(stopWatch,0);}
  }
  if (startOrStop == 40){
...
function colourfunc(){
  document.querySelectorAll("button")[colourVariable - 1].classList.add("colour");
setTimeout(function ()  {document.querySelectorAll("button")[colourVariable -1].classList.remove("colour");
colourVariable++;},100);
